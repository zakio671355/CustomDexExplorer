...
Main = (function()
	...
	Main.CreateIntro = function(initStatus)
		local gui = create({
			...
			{101,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Customizer",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text="Customized by Funnex",TextColor3=Settings.Theme.Important,TextSize=14,TextXAlignment=1,}},
			{102,"UIGradient",{Parent={101},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-50),Size=UDim2.new(0,105,0,20),Text=Main.Version,TextColor3=Settings.Theme.Text,TextSize=14,TextXAlignment=1,}},
		...
		local customizerText = gui.Main.Customizer
		local customizerGradient = customizerText.UIGradient
		...
		rightTextTransparency(customizerGradient)
		...
		local function close()
			...
			tweenS:Create(customizerText,progressTI,{TextTransparency = 1}):Play()
